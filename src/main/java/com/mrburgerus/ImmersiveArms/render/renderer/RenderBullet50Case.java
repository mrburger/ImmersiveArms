...
import com.mrburgerus.ImmersiveArms.render.model.ModelBullet50Case;
...
public class RenderBullet50Case implements IItemRenderer
{
    //fields
    private ModelBullet50Case modelBullet50;
    public static ResourceLocation texture = new ResourceLocation(ImmersiveArms.MODID + ":" + "textures/models/bullet50.png" );

    //constructors
    public RenderBullet50Case()
    {
        modelBullet50 = new ModelBullet50Case();
    }
